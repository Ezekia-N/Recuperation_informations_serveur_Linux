...
"}")
        icon = QIcon()
        icon.addFile(u":/icons/icons/menu.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/ecran-dordinateur.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/ordinateur.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/linternet.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        self.bouton_ressource = QPushButton(self.sidebar)
        self.bouton_ressource.setObjectName(u"bouton_ressource")
        self.bouton_ressource.setStyleSheet(u"QPushButton\n"
"{\n"
"	background:transparent;\n"
"	width: 100%;\n"
"	padding: 7px 0px 7px 10px;\n"
...
"}")
        ...
        self.bouton_ressource.setIcon(icon5)
        self.bouton_ressource.setIconSize(QSize(20, 20))

        self.verticalLayout.addWidget(self.bouton_ressource)
...
"border-radius: 20px;")
        ...
        self.label_6.setPixmap(QPixmap(u":/icons/icons/monitor.png"))
...
"border-radius: 20px;")
        ...
        self.label_8.setPixmap(QPixmap(u":/icons/icons/chip.png"))
...
"border-radius: 20px;")
        ...
        self.label_9.setPixmap(QPixmap(u":/icons/icons/memory.png"))
...
"border-radius: 20px;")
        ...
        self.label_10.setPixmap(QPixmap(u":/icons/icons/hard-drive.png"))
...
"border-radius: 20px;")
        ...
        self.gridLayoutWidget_8.setGeometry(QRect(10, 40, 311, 361))
        ...
        self.label_19.setPixmap(QPixmap(u":/icons/icons/chip.png"))
...
"border-radius: 20px;")
        ...
        self.gridLayoutWidget_9.setGeometry(QRect(10, 40, 311, 361))
        ...
        self.label_21.setPixmap(QPixmap(u":/icons/icons/memory.png"))
...
"border-radius: 20px;")
        ...
        self.gridLayoutWidget_10.setGeometry(QRect(10, 40, 311, 361))
        ...
        self.label_23.setPixmap(QPixmap(u":/icons/icons/hard-drive.png"))
...
"border-radius: 20px;")
        ...
        self.gridLayoutWidget_13.setGeometry(QRect(10, 30, 1001, 161))
        ...
        self.verticalLayoutWidget_5 = QWidget(self.groupBox_23)
        self.verticalLayoutWidget_5.setObjectName(u"verticalLayoutWidget_5")
        self.verticalLayoutWidget_5.setGeometry(QRect(10, 200, 1001, 151))
        self.gridLayoutPartition = QVBoxLayout(self.verticalLayoutWidget_5)
        self.gridLayoutPartition.setObjectName(u"gridLayoutPartition")
        self.gridLayoutPartition.setContentsMargins(0, 0, 0, 0)
...
"border: none;")
        ...
        self.pageRessouceUsage = QWidget()
        self.pageRessouceUsage.setObjectName(u"pageRessouceUsage")
        self.verticalLayout_6 = QVBoxLayout(self.pageRessouceUsage)
        self.verticalLayout_6.setSpacing(10)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.verticalLayout_6.setContentsMargins(20, 10, 15, 2)
        self.conteneur_titreParMenu_4 = QGroupBox(self.pageRessouceUsage)
        self.conteneur_titreParMenu_4.setObjectName(u"conteneur_titreParMenu_4")
        self.conteneur_titreParMenu_4.setStyleSheet(u"border:none;\n"
"background:transparent;")
        self.label_titreParMenu_11 = QLabel(self.conteneur_titreParMenu_4)
        self.label_titreParMenu_11.setObjectName(u"label_titreParMenu_11")
        self.label_titreParMenu_11.setGeometry(QRect(0, 0, 181, 18))
        self.label_titreParMenu_11.setFont(font)
        self.label_descriptionParMenu_4 = QLabel(self.conteneur_titreParMenu_4)
        self.label_descriptionParMenu_4.setObjectName(u"label_descriptionParMenu_4")
        self.label_descriptionParMenu_4.setGeometry(QRect(0, 20, 341, 18))

        self.verticalLayout_6.addWidget(self.conteneur_titreParMenu_4)

        self.widget = QWidget(self.pageRessouceUsage)
...
"border:none;")
        ...
        self.groupBox_ressource = QGroupBox(self.widget)
        self.groupBox_ressource.setObjectName(u"groupBox_ressource")
        self.groupBox_ressource.setStyleSheet(u"background-color:#101E34;\n"
"color:#F0F5FF;\n"
"border-radius: 20px;")
        self.verticalLayout_9 = QVBoxLayout(self.groupBox_ressource)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.groupBox_ressource_layout = QVBoxLayout()
        self.groupBox_ressource_layout.setObjectName(u"groupBox_ressource_layout")

        self.verticalLayout_9.addLayout(self.groupBox_ressource_layout)


        self.horizontalLayout_7.addWidget(self.groupBox_ressource)
        ...
        self.conteneur_accueil.addWidget(self.pageRessouceUsage)
...
"border:none;")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/application(1).png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bouton_fermer.setIcon(icon6)
        self.bouton_fermer.setIconSize(QSize(16, 16))
        self.bouton_actualiser = QPushButton(self.groupBox_2)
        self.bouton_actualiser.setObjectName(u"bouton_actualiser")
        self.bouton_actualiser.setGeometry(QRect(60, 0, 101, 26))
        icon7 = QIcon()
        icon7.addFile(u":/icons/icons/rafraichir.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bouton_actualiser.setIcon(icon7)
        self.bouton_actualiser.setIconSize(QSize(16, 16))
        ...
        self.conteneur_accueil.setCurrentIndex(0)
    ...
    def retranslateUi(self, Widget):
        ...
        self.bouton_ressource.setText(QCoreApplication.translate("Widget", u" Ressource usage", None))
        ...
        self.conteneur_titreParMenu_4.setTitle("")
        self.label_titreParMenu_11.setText(QCoreApplication.translate("Widget", u"Utilisation de ressource", None))
        self.label_descriptionParMenu_4.setText(QCoreApplication.translate("Widget", u"Information d\u00e9taill\u00e9 sur l'utilisation des ressources", None))
        self.groupBox_ressource.setTitle("")
        self.groupBox_2.setTitle("")
        self.bouton_fermer.setText("")
        self.bouton_actualiser.setText(QCoreApplication.translate("Widget", u" Actualiser", None))
    # retranslateUi
